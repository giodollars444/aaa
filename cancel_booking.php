...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['email'])) {
    ...
    if (filter_var($email, FILTER_VALIDATE_EMAIL)) {
        ...
        $stmt = $conn->prepare("SELECT id, nome, menu, numero_persone, data_prenotazione, orario, tavolo_preferito, stato FROM prenotazioni WHERE email = ? AND (stato IS NULL OR stato != 'Cancellata') ORDER BY data_prenotazione DESC, orario DESC");
...
if (isset($_POST['cancel_booking_id']) && isset($_POST['confirm_cancel'])) {
    ...
    $stmt = $conn->prepare("SELECT id, nome, menu, numero_persone, data_prenotazione, orario, tavolo_preferito, stato FROM prenotazioni WHERE id = ? AND email = ? AND (stato IS NULL OR stato != 'Cancellata')");
...
<head>
    ...
    <title>Cancella Prenotazione - AkiraOne</title>
    ...
    <div class="container">
        ...
        <?php if (isset($cancellation_success)): ?>
            <div class="message success">
                ...
                La tua prenotazione per <?php echo htmlspecialchars($cancelled_booking['menu'] ?: 'tavolo'); ?> 
                    ...
                    <div class="booking-card">
                        <div class="booking-info">
                            <div class="booking-details">
                                <h4><?php echo htmlspecialchars($booking['menu'] ?: 'Tavolo per ' . $booking['numero_persone'] . ' persone'); ?></h4>
                                ...
                                <p><i class="fas fa-users"></i> <?php echo $booking['numero_persone']; ?> persone</p>
                                <p><i class="fas fa-chair"></i> <?php echo ucfirst(str_replace('_', ' ', $booking['tavolo_preferito'])); ?></p>
